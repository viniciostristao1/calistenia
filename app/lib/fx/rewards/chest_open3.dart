...
/// traseira).
class ChestOpen3 extends StatefulWidget {
  const ChestOpen3({
    super.key,
  ...
  /// A pontuação que sobe do baú (ex.: +50). Vem do slider "Valor (+XP / ⭐)".
  final num? valorScore;

  @override
  State<ChestOpen3> createState() => _ChestOpen3State();
}

class _ChestOpen3State extends State<ChestOpen3>
        ...
        builder: (context, _) {
          ...
          return Stack(
            ...
            children: [
              ...
              // O baú em 3/4.
              _chest(v),
              // A recompensa: a PONTUAÇÃO sobe com as 3 setas animadas (sem
              // estrela — é o "subiu de nível" saindo do baú).
              if (v > 0.55)
                FlyToTarget(
...
class _ChestPainter3 extends CustomPainter {
  _ChestPainter3({required this.v, required this.intensity});
  ...
  @override
  bool shouldRepaint(_ChestPainter3 old) =>
