...
- **2026-09-12 — v0.76.0 (Rating em 0–1000: qualquer ganho aparece):**
  ...
  - O texto explicativo e a barrinha foram atualizados; a lógica de pontuação continua a mesma (só com mais resolução).
...
- **2026-09-12 — v0.69.2 (baú fechado sem estrelas vazando):**
  - Corrigido: com a **tampa fechada**, algumas estrelas do canto direito apareciam antes de abrir. Agora a tampa cobre tudo enquanto está fechada (e vai liberando conforme abre).
...
- **2026-08-29 — v0.55.1 (fluxo mais lento):**
  - Deixado um pouco mais lento e vivo: halo `900ms`, cascata `560ms + 110ms` por item e confete `2400ms` — mais cara de vídeo móvel.
